...
- Η διαχείριση 3rd party βιβλιοθηκών (Onelogin PHP Saml Toolkit και XMLSeclibs) γίνεται μέσω composer, οπότε θα πρέπει να έχει εγκατασταθεί ο composer.
...
Εκτελείτε την εντολή composer install ώστε να εγκατασταθούν τα 3rd party dependencies.
...
## Οδηγίες αναβάθμισης στην έκδοση 1.2.6 από προηγούμενες εκδόσεις

1. Εγκαταστήστε τον composer σύμφωνα με τις οδηγίες εδώ: https://getcomposer.org/doc/00-intro.md
2. Εκτελέστε την εντολή composer install προκειμένου να εγκατασταθούν τα dependencies.

## Οδηγίες αναβάθμισης στην έκδοση 1.2.7 από την 1.2.6

1. Από το αρχείο `upgrade.php` εκτελέστε μόνο εκείνο το τμήμα που αφορά την αναβάθμιση στην έκδοση 1.2.7
...
## Changelog από την έκδοση 1.2.4 σε 1.2.6

- Διορθώσεις bugs
- Διαχείριση 3rd party dependencies μέσω composer

## Changelog από την έκδοση 1.2.6 σε 1.2.7

- Διορθώσεις bugs
- Δυνατότητα προβολής των μελών ενός τμήματος για τον ρόλο fm μέσω του πεδίου viewDeptMembers στον πίνακα pa_user
