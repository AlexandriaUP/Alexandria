...
/* Check access rights */
if ( !isset($_SESSION["role"]) || $_SESSION["role"] != "fm" || !isset($_SESSION['viewDeptMembers']) || is_null($_SESSION['viewDeptMembers'])){ header("Location: error.php?ec=ad"); exit; }

$mysqli = createDatabaseConnection();
$facultyMembers = getFacultyMembers($mysqli, $_SESSION['viewDeptMembers']);
$mysqli -> close();
...
<html  lang="<?php echo $_SESSION['lang'];?>">
   ...
   <body class="hold-transition sidebar-mini">
      <div class="wrapper">
         ...
         <!-- Side bar -->
         <?php echo getSideBarMenu($_SESSION["role"], "deptMembers"); ?>
